...
## Corpus Check
- 220 files · ~137,088 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1181 nodes · 2011 edges · 87 communities (66 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `894f6f30`
...
- CLAUDE.md
- login/page.tsx
- productshot/dashboard/page.tsx
- app.py
- AlarmReceiver.kt
...
- `EditReminderActivity` --references--> `Reminder`  [EXTRACTED]
  reminder-app/app/src/main/java/online/productwithrohan/reminders/EditReminderActivity.kt → reminder-app/app/src/main/java/online/productwithrohan/reminders/Reminder.kt
...
### Community 1 - "Store"
Cohesion: 0.06
Nodes (25): AppCompatActivity, Bundle, MainActivity, ProgressBar, SharedPreferences, CloudflareRefresher, WebViewClient, Context (+17 more)
...
Cohesion: 0.07
Nodes (36): corsHeaders(), GET(), OPTIONS(), corsHeaders(), GET(), OPTIONS(), dynamic, GET() (+28 more)
...
Cohesion: 0.14
Nodes (10): MasterKey, JournalEntry, JSONObject, JournalStore, Context, EncryptedFile, JournalSyncManager, changed (+2 more)

### Community 13 - "productshot/MainActivity.kt"
Cohesion: 0.14
Nodes (14): isInAppHost(), isSupabaseDownloadUrl(), AppCompatActivity, Bundle, Intent, Uri, WebView, WebViewClient (+6 more)
...
### Community 16 - "AlarmService"
Cohesion: 0.25
Nodes (8): AlarmService, Context, IBinder, Intent, MediaPlayer, Notification, Service, Vibrator
...
Cohesion: 0.15
Nodes (12): Article, ArticlesClient(), Bookmark, Props, BookmarkedItem, BookmarksPage(), CONTENT_TYPE_LABELS, dynamic (+4 more)

### Community 19 - "UsageWidgetProvider"
Cohesion: 0.11
Nodes (18): AppWidgetManager, AppWidgetProvider, BootReceiver, BroadcastReceiver, Context, Intent, IntArray, BootReceiver (+10 more)
...
### Community 22 - "shots/generate.ts"
Cohesion: 0.23
Nodes (10): CONTENT_MODEL, createAnthropicClient(), GeneratedNewsItem, generateNewsItems(), NEWS_SCHEMA, GeneratedShot, generateShotQuestion(), SHOT_QUESTION_SCHEMA (+2 more)
...
Cohesion: 0.33
Nodes (5): ByteArray, JournalMediaStore, Context, EncryptedFile, Uri

### Community 25 - "productshot/layout.tsx"
Cohesion: 0.33
Nodes (4): metadata, BottomNav(), Tab, tabs
...
Cohesion: 0.21
Nodes (9): Bookmark, Props, EPOCH, ShotSelector, Profile, SHOT_TYPE_LABELS, SHOT_TYPES, ShotQuestion (+1 more)
...
### Community 43 - "productshot/dashboard/page.tsx"
Cohesion: 0.18
Nodes (12): DashboardPage(), revalidate, Bookmark, NewsClient(), Props, NewsPage(), revalidate, revalidate (+4 more)
...
## Knowledge Gaps
- **204 isolated node(s):** `graphify`, `Post`, `PostFrontmatter`, `PostWithContent`, `Article` (+199 more)
...
- **Why does `Store` connect `Store` to `HttpOutcome`, `NotificationManager`, `MainActivity`, `ClaudeAlertsActivity`, `UsageWidgetProvider`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `JournalEntry` connect `JournalEntry` to `JournalEditActivity`?**
...
- **What connects `graphify`, `Post`, `PostFrontmatter` to the rest of the system?**
