  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 top-4 z-40 flex h-10 w-10 items-center justify-center rounded-lg bg-white/80 dark:bg-slate-900/80 backdrop-blur"
      >
        <svg
      ...
      >
        ...
        <div className="bg-gradient-to-br from-blue-400 to-blue-500 dark:from-blue-900 dark:to-blue-800 px-6 py-8">
          <div className="flex items-center gap-4">
            <div
              className="flex h-16 w-16 items-center justify-center rounded-full bg-red-500 text-2xl font-bold text-white"
            >
              {getInitial()}
            </div>
        ...
        <nav className="flex flex-1 flex-col overflow-y-auto divide-y divide-slate-200 dark:divide-slate-700">
          ...
          <Link
            href="/handbook"
            onClick={() => {
              track("handbook_link_click", { source: "productshot_sidebar" });
              setIsOpen(false);
            }}
            className="flex items-center gap-3 px-6 py-4 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"
          >
          ...
          {user?.email === "rohankhullar24@gmail.com" && (
            <a
              href="https://course.productalliance.com/library"
              target="_blank"
